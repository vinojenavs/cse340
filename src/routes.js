...
import { organizationsPage, organizationDetailPage, processNewOrganization, newOrganizationForm } from './controllers/organizations.js';
...
router.post('/new-organization', processNewOrganization);
